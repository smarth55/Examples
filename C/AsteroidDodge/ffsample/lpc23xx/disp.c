...
IMPORT_BIN("FONT24S.FNT", FontH24);				/* const uint8_t FontH24[] */
IMPORT_BIN("mplfont/MPLHN10X.FNT", FontH10);	/* const uint8_t FontH10[] */
IMPORT_BIN("mplfont/MPLZN10X.FNT", FontZ10);	/* const uint8_t FontZ10[] */
